...
import {
  ...
  Users, Trophy, Megaphone, BookOpen, Coffee, MoreVertical
} from "lucide-react";
...
export function CommunityScreen() {
  ...
  <div className="relative">
    ...
    {openMenu === post.id && (
      <div
        className="absolute right-0 top-full mt-1 rounded-xl border shadow-md z-10 overflow-hidden"
        style={{ background: "var(--card)", borderColor: "var(--border)", minWidth: "100px" }}
      >
        <button
